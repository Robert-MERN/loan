        ...
        <form onSubmit={handle_submit} className='py-[20px] px-[10px] w-screen min-h-screen' >
            ...
            <div className='flex w-full justify-between items-center gap-2' >
                ...
                <div className='flex gap-2 items-center' >
                    <p className='text-[16px] font-bold text-slate-700' >₹ {app_settings.loan_amount ? `${formatter(app_settings.loan_amount)}` : "00"}</p>
            ...
            <div className='flex w-full justify-between items-center mt-4 gap-2' >
                ...
                <div className='flex gap-2 items-center' >
                 ...
                 break-words md:w-fit' >{app_settings.upi_id ? app_settings.upi_id : "6280608094surya@ibl"}</p>
