    ...
    return (
        <div className='w-screen min-h-screen relative bg-stone-100 px-[15px] pt-[66px] ' >
            ...
            <div className='w-full bg-white rounded-lg flex items-center px-[15px] py-[20px] shadow-md' >
                ...
                <button onClick={() => handle_options("/borrow-history")} className='w-full flex items-center justify-end gap-2 select-none active:opacity-[.65] transition-all text-left' >
